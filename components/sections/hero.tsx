  ...
  return (
    ...
    >
        ...
        {isDesktop ? (
          <>
            <div className="overflow-hidden mb-4">
              <motion.h1
                className="font-display text-6xl md:text-7xl lg:text-7xl xl:text-[5rem] 2xl:text-8xl tracking-tight text-white"
                initial={{ y: '100%' }}
                animate={{ y: 0 }}
            ...
            >
              <MagneticButton strength={0.4}>
                <a
                  ...
                  className="group relative inline-flex items-center gap-3 px-10 py-5 bg-transparent border border-[#25D366] text-[#25D366] text-lg font-semibold rounded-full overflow-hidden transition-all hover:bg-[#25D366]/10 hover:scale-105"
                >
      ...
      >
        ...
        >
          <span className="text-[13px] tracking-widest uppercase">Descubrí más</span>
