        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          >
            ...
            <MagneticButton strength={0.2} className="w-full">
              ...
              >
                <motion.div
                  className="w-16 h-16 glass border border-[#25D366]/50 rounded-2xl flex items-center justify-center shadow-lg shadow-[#25D366]/20"
            ...
            <TiltCard>
              <div className="glass-strong rounded-2xl p-6">
                <div className="flex items-start gap-5">
                  <div className="w-16 h-16 glass border border-accent/50 rounded-2xl flex items-center justify-center shadow-lg">
